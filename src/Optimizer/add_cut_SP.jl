function add_cut_SP(cb_data, options::Options, master_pb::JuMP.Model, oracle_pb, instance::Instance, Time_subproblem, solution_x::Vector{Matrix{Float64}}, solution_gamma::Dict{Tuple{Int64, Int64, Int64}, Float64}; force::Float64, S::Int64, batch=1, gap)
    """
    Add Benders' cut
    """
...
function add_cut_3bin(cb_data, options::Options, master_pb::JuMP.Model, oracle_pb, instance::Instance, Time_subproblem, solution_x::Vector{Matrix{Float64}}; force::Float64, S::Int64, batch=1, gap)
    T= instance.TimeHorizon
    thermal_units=instance.Thermalunits
